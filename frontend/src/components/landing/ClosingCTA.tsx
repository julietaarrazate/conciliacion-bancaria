        ...
        <div className="cta-card">
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.75)', maxWidth: 420, margin: '0 auto 32px', lineHeight: 1.65 }}>
              Demo en vivo de 20 minutos, onboarding incluido, soporte directo con la desarrolladora. Sin burocracia.
            </p>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px', borderRadius: 12, background: '#fff', color: 'var(--accent-2)', fontWeight: 700, fontSize: 15, textDecoration: 'none', border: 'none' }}>
