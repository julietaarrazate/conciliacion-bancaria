    ...
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="flex justify-end mb-3 gap-2">
          <button
            onClick={() => { setExportWarn([]); setExportModalOpen(true) }}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setExportModalOpen(false)}>
          <div className="bg-white dark:bg-ml-dark-surface rounded-2xl shadow-xl w-full max-w-sm" onClick={e => e.stopPropagation()}>
            <div className="p-4 border-b border-gray-200 dark:border-ml-dark-border flex items-center justify-between">
              ...
              <button onClick={() => setExportModalOpen(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">✕</button>
            </div>
            <div className="p-4 space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                  {exportFormato === 'csv' && 'CSV separado por comas, UTF-8, con header.'}
                  {exportFormato === 'tango' && 'TXT tab-separado, coma decimal, Latin-1. Sin encabezado.'}
                  {exportFormato === 'holistor' && 'TXT punto-y-coma, coma decimal, Latin-1.'}
                  {exportFormato === 'regisoft' && 'CSV coma, punto decimal, UTF-8. Columnas: Fecha, Cuenta, Detalle, Debe, Haber.'}
                </p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
              ...
              {exportWarn.length > 0 && (
                <div className="rounded-lg bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 p-3">
                  ...
                  <p className="text-xs text-yellow-700 dark:text-yellow-400">{exportWarn.join(', ')}</p>
            ...
            <div className="p-4 border-t border-gray-200 dark:border-ml-dark-border flex justify-end gap-2">
              ...
              <button onClick={handleExportContable} disabled={exportLoading}
